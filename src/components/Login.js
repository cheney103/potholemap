            ...
            <div class="bg-grey-lighter min-h-screen flex flex-col bg-blue-500">
                <div class="container max-w-sm mx-auto flex-1 flex flex-col items-center justify-center px-2">
                    <div class="bg-white px-6 py-8 rounded shadow-md text-black w-full ">
                        ...
                        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <>
                                <input
                                    ...
                                    type="password"
                                    ref={register} />
                                    <Link to='/forgot-password'><p class="text-right"><span class="cursor-pointer text-sm text-yellow-600">Forgot Password?</span></p></Link>
                            </>
                            <p className="messages">
                        ...
                        <p class="text-center text-sm text-grey-dark mt-4 cursor-default">Don't have an account? <Link to='/signup'><span class="cursor-pointer text-yellow-600">Register Here</span></Link></p>
                    </div>
                </div>
            </div>
        </div>
